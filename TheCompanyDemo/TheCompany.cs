    ...
    public class TheCompany
    {
        public object[] Build()
        {
            ...
            var Emps = new[]
            {
                ...
                new Employee { Id = 3532, FirstName = "Wesley", LastName = "Crusher", ReportsToId = 101},
                new Employee { Id = 6532, FirstName = "Dianna", LastName = "Troy", ReportsToId = 101},
                ...
                new Employee {Id = 40192, FirstName = "Harry", LastName = "Kim", ReportsToId = 102}
            };
            ...
            var CRs = new[]
            {
                ...
                new ConfrenceRoom { Id= 5, Name = "Mess Hall", SeatingCapacity = 50, HasProjector = true}
            };
